...
export function TableHead({
  ...
  return (
    <th
      className={cn(
        "h-8 whitespace-nowrap px-2.5 text-left align-middle leading-none has-[[role=checkbox]]:w-px last:has-[[role=checkbox]]:ps-0 first:has-[[role=checkbox]]:pe-0",
        LABEL,
        className,
      )}
...
export function TableCell({
  ...
  return (
    <td
      className={cn(
        "whitespace-nowrap bg-clip-padding px-2.5 py-1.5 in-data-[slot=table-footer]:py-3.5 align-middle leading-none in-data-[variant=card]:first:ps-[calc(--spacing(2.5)-1px)] in-data-[variant=card]:last:pe-[calc(--spacing(2.5)-1px)] has-[[role=checkbox]]:w-px last:has-[[role=checkbox]]:ps-0 first:has-[[role=checkbox]]:pe-0",
        className,
      )}
