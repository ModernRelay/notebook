...
export function CardHeader({
  ...
  const defaultProps = {
    className: cn(
      "grid auto-rows-min grid-rows-[auto_auto] items-start gap-1 px-4 pt-3 pb-2 in-[[data-slot=card]:has(>[data-slot=card-panel])]:pb-2 has-data-[slot=card-action]:grid-cols-[1fr_auto]",
      className,
    ),
...
export function CardPanel({
  ...
  const defaultProps = {
    className: cn(
      "flex-1 px-4 pt-4 pb-4 in-[[data-slot=card]:has(>[data-slot=card-header]:not(.border-b))]:pt-0 in-[[data-slot=card]:has(>[data-slot=card-footer]:not(.border-t))]:pb-0",
      className,
    ),
